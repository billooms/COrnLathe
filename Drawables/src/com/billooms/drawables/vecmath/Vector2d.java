 ...
 *
 * $Revision: 127 $
 * $Date: 2008-02-28 13:18:51 -0700 (Thu, 28 Feb 2008) $
 * $State$
 */
package com.billooms.drawables.vecmath;
...
public class Vector2d extends Tuple2d implements java.io.Serializable {
  ...
  /**
   * Rotate this vector through the given angle (counter clockwise). This
   * provides a new vector (the original is unchanged).
   *
  ...
  public Vector2d rotate(double ang) {
    ...
    return new Vector2d(this.x * Math.cos(angRad) - this.y * Math.sin(angRad),
        this.y * Math.cos(angRad) + this.x * Math.sin(angRad));
  }
