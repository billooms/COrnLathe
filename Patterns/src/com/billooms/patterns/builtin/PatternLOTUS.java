 ...
 */
@ServiceProvider(service = Pattern.class, position = 70)
public class PatternLOTUS extends BasicPattern {

  /**
   * Create a new Lotus pattern
   */
  public PatternLOTUS() {
    super("Lotus");
  }
  ...
  public double getValue(double n) {
    ...
    z = nn + 0.1 * z;					// the factor 0.1 was determined by a nice appearance
    return z;
  }
}
