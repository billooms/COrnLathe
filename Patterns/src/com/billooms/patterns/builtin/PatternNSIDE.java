...
/**
 * N-Sided pattern (like an N-Sided polygon)
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 20)
public class PatternNSIDE extends BasicPattern {

  /**
   * Create a new N-Sided pattern (line an N-Sided polygon).
   */
  public PatternNSIDE() {
    super("N-Side");
    needsRepeat = true;
