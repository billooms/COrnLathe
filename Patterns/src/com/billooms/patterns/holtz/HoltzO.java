...
/**
 * Holtzapffel O -- alternates 5 small and large (3X) bumps.
 *
 * Note: repeat is strictly the number of repeats of the base pattern. This is
 * NOT the same numbering that Holtzapffel uses! Holtz number is 6*repeat.
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 250)
public class HoltzO extends BasicPattern {

  // number of small bumps per repeat
  private final static int TOTAL = 8;
  // number of small bumps
  private final static int NSMALL = 5;
  // size of big bumps
