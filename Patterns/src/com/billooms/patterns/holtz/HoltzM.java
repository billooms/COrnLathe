...
/**
 * Holtzapffel M -- alternates 3 small and large (3X) bumps.
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 230)
public class HoltzM extends BasicPattern {

  // number of small bumps per repeat
  private final static int TOTAL = 6;
  // number of small bumps
  private final static int NSMALL = 3;
  // size of big bumps
