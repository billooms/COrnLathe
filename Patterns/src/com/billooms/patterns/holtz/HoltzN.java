...
/**
 * Holtzapffel N -- alternates 4 small and large (2X) bumps.
 *
 * Note: repeat is strictly the number of repeats of the base pattern. This is
 * NOT the same numbering that Holtzapffel uses! Holtz number is 5*repeat.
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 240)
public class HoltzN extends BasicPattern {

  // number of small bumps per repeat
  private final static int TOTAL = 6;
  // number of small bumps
  private final static int NSMALL = 4;
  // size of big bumps
