...
/**
 * Holtzapffel P -- sine wave with every 5th & 6th valley missing.
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 260)
public class HoltzP extends BasicPattern {
