...
/**
 * Holtzapffel R -- alternates 2 small and large (2X) bumps.
 *
 ...
 */
@ServiceProvider(service = Pattern.class, position = 280)
public class HoltzR extends BasicPattern {

  // number of small bumps per repeat
  private final static int TOTAL = 4;
  // number of small bumps
  private final static int NSMALL = 2;
  // size of big bumps
